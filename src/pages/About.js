...
<p className="text-[40px] font-bold">Our Mission <br></br> </p>
 ...
 <p className="text-gray-500 font-medium">Our mission is to be your go-to destination for all things delicious and meaty. We strive to:</p>

 <p className="text-gray-500 font-medium">Source the highest quality ingredients: We carefully select premium meats, fresh produce, and the finest spices to ensure that every dish is crafted with excellence. <br></br></p>
 <p className="text-gray-500 font-medium">Offer a diverse menu: From succulent steaks and juicy burgers to flavorful curries and savory kebabs, we cater to a wide range of palates with our diverse menu. <br></br></p>
 <p className="text-gray-500 font-medium">Provide a seamless ordering experience: Our user-friendly website and reliable delivery services make it easy to satisfy your cravings whenever they strike. <br></br></p>
...
<p className="text-[40px] font-bold">What You'll Find on Chops <br></br> </p>
 ...
 <p className="text-gray-500 font-medium">Easy Online Ordering: Place your order with just a few clicks and have your delicious meal delivered right to your doorstep. <br></br></p>
...
<p className="text-gray-500 font-medium">Indulge your cravings today! Browse our menu, place your order, and experience the difference of Chops. <br></br> </p>


<div className="text-gray-500">
<p className="text-right font-medium text">Where Flavor Reigns Supreme.</p>
<p className="text-right font-medium">-Chops</p>
</div>
